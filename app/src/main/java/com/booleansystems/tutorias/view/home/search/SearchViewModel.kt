...
class SearchViewModel : ViewModel() {
    ...
    val listSearchResults = MutableLiveData<MutableList<SubjectEntity>>()

    fun loadDummyData() {
        listSearchResults.value = GsonBuilder().create().fromJson(getDummyJsonData(), Array<SubjectEntity>::class.java)
            .toMutableList()
    }
